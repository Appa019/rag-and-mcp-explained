      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-10 md:flex-row md:items-end md:justify-between md:px-10">
        <div className="max-w-md">
          <p className="font-serif text-lg leading-snug text-ink">
            Material educacional sobre RAG e MCP.
          </p>
          <p className="mt-2 text-sm leading-relaxed text-ink-muted">
            Site estático, sem banco vetorial ou chamadas de API. Os
            vetores foram descritos em oito dimensões semânticas nomeadas
            para fins de leitura didática.
          </p>
        </div>
